...
function setPassword() {
    ...
    document
        ...
        .addEventListener("submit", async function (event) {
            ...
            // Display incorrect password message if the passwords do not match
            else {
...
/**
 * When the try again button is clicked, the error message is removed
 */
...
function togglePasswordForm() {
    // Toggles the visibility of the password settings form.
...
/**
 * Checks whether the user wants Markdown editing enabled or not, then sets it in localStorage
 * @function
